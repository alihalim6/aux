    ...
    <v-app>
        ...
        <div class="splash-container">
          ...
          <div class="under-construction">
            <div class="tbd-message">*This web application is still in development.  Apps in development that use Spotify's API have to use a beta.  
              If you're interested in getting added to the list and seeing the app at its current stage, let's connect! Message me on LinkedIn and I'll get you added right away.  
