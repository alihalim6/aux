<template>
  <v-footer class="currently-playing-container" :class="{'up-next-displaying': upNextDisplaying, 'up-next-hidden': upNextHidden}">
    <div class="clickable view-queue-container" v-if="!upNextDisplaying">      
    ...
    <div class="currently-playing" v-if="!upNextDisplaying">
      ...
      <div class="d-flex flex-column align-start mt-2"  @click.stop="viewUpNext()">
...
<style lang="scss">
  ...
  $slide-animation: 0.42s forwards 1 ease-in-out;

  .up-next-displaying {
    background-color: black !important;
    color: white !important;
    animation: slide-up $slide-animation;
  ...
  .up-next-hidden {
    ...
    animation: slide-down $slide-animation;
