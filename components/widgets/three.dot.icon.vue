<template>
  <v-menu bottom left :transition="detailOverlay ? 'slide-x-reverse-transition' : 'slide-x-transition'" z-index="2000" :nudge-left="item.isArtsit && detailOverlay ? 100 : 20" :value="!hide">
